...
// CHECK:         %[[GROUP:.*]] = tcp.group attributes {group_type = "elementwise"} {
...
// CHECK:         %[[GROUP1:.*]] = tcp.group attributes {group_type = "elementwise"} {
...
// CHECK:         %[[GROUP2:.*]] = tcp.group attributes {group_type = "elementwise"} {
