...
// CHECK:         %[[BCAST:.*]] = tcp.broadcast %[[ARG0]], %[[ARG1]] {axes = [0 : index]} : tensor<1x?xf32>, index -> tensor<?x?xf32>
// CHECK:         return %[[BCAST]] : tensor<?x?xf32>
func.func @test_broadcast(%arg0 : tensor<1x?xf32>, %arg1 : index) -> tensor<?x?xf32> {
  %0 = "tcp.broadcast"(%arg0, %arg1) {axes = [0 : index]} : (tensor<1x?xf32>, index) -> tensor<?x?xf32>
...
// CHECK:         %[[BCAST:.*]] = tcp.broadcast %[[ARG0]], %[[ARG1]], %[[ARG2]] {axes = [1 : index, 3 : index]} : tensor<?x1x?x1xf32>, index, index -> tensor<?x?x?x?xf32>
...
func.func @test_broadcast_multiple_dims(%arg0 : tensor<?x1x?x1xf32>, %arg1 : index, %arg2 : index) -> tensor<?x?x?x?xf32> {
  %0 = "tcp.broadcast"(%arg0, %arg1, %arg2) {axes = [1 : index, 3 : index]} : (tensor<?x1x?x1xf32>, index, index) -> tensor<?x?x?x?xf32>
...
func.func @test_broadcast_diff_rank(%arg0 : tensor<?xf32>, %arg1 : index) -> tensor<?x?xf32> {
  ...
  %0 = "tcp.broadcast"(%arg0, %arg1) {axes = [0 : index]} : (tensor<?xf32>, index) -> tensor<?x?xf32>
  return %0 : tensor<?x?xf32>
}
...
func.func @test_broadcast_diff_elem_type(%arg0 : tensor<1x?xf32>, %arg1 : index) -> tensor<?x?xi32> {
  ...
  %0 = "tcp.broadcast"(%arg0, %arg1) {axes = [0 : index]} : (tensor<1x?xf32>, index) -> tensor<?x?xi32>
...
func.func @test_broadcast_diff_num_axes(%arg0 : tensor<1x1xf32>, %arg1 : index, %arg2 : index) -> tensor<?x?xf32> {
  ...
  %0 = "tcp.broadcast"(%arg0, %arg1, %arg2) {axes = [0 : index]} : (tensor<1x1xf32>, index, index) -> tensor<?x?xf32>
  return %0 : tensor<?x?xf32>
}
...
func.func @test_broadcast_axes_not_sorted(%arg0 : tensor<?x1x?x1xf32>, %arg1 : index, %arg2 : index) -> tensor<?x?x?x?xf32> {
  ...
  %0 = "tcp.broadcast"(%arg0, %arg1, %arg2) {axes = [3 : index, 1 : index]} : (tensor<?x1x?x1xf32>, index, index) -> tensor<?x?x?x?xf32>
  return %0 : tensor<?x?x?x?xf32>
}
...
func.func @test_broadcast_axes_w_duplicates(%arg0 : tensor<?x1x?x1xf32>, %arg1 : index, %arg2 : index) -> tensor<?x?x?x?xf32> {
  ...
  %0 = "tcp.broadcast"(%arg0, %arg1, %arg2) {axes = [1 : index, 1 : index]} : (tensor<?x1x?x1xf32>, index, index) -> tensor<?x?x?x?xf32>
  return %0 : tensor<?x?x?x?xf32>
}
